      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {teamMembers.map((member, index) => (
            <Card
              key={index}
              className="team-card border-none shadow-xl overflow-hidden group hover:shadow-2xl transition-all duration-300 border-l-4 border-orange-500 hover:border-l-8 h-auto min-h-[400px] md:min-h-[400px]"
            >
              {/* Header with role indicator */}
              <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-4">
                <div className="flex items-center justify-between">
              ...
              <div className="flex flex-col md:flex-row flex-1">
                ...
                <div className="w-full md:w-2/3 p-6 flex flex-col justify-between">
                  <div>
                    ...
                    <CardContent className="p-0">
                      <p className="text-slate-600 dark:text-slate-400 mb-6 text-sm leading-relaxed">{member.bio}</p>
                    </CardContent>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {member.expertise.map((skill, skillIndex) => (
                        <span
                          key={skillIndex}
                          className="px-3 py-1.5 bg-orange-50 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 rounded-full text-xs font-medium"
                        >
                          {skill}
                        </span>
                      ))}
